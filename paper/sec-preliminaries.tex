...
\modify{
    The relations in $\vec{R_v}$ and $\vec{R_e}$ are called representing vertices and edges, respectively.
}
...
\begin{example}
    \modify{
    Given an SPJM query shown in Fig.~\ref{fig:spjm}, this query aims to find two persons who like the same message, one of whom lives in Germany.    
