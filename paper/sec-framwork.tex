...
because pushing the predicate into the matching operator does not always result in a better plan, and it is necessary to specifically determine whether to push down the predicate}.
\iffalse
