...
\item We have implemented \name~ based on the industrial relational optimization framework Calsite~\cite{calsite}.
\todo{add more of implementations and experiment findings.}
Our contributions are substantiated by experimental results that underscore the efficacy of the proposed optimization framework. These results highlight the advantages of our approach in real-world applications, providing empirical evidence to support the theoretical advancements posited in our study.
