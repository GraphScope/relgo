...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \begin{subfigure}[b]{.45\linewidth}
            \centering
            \includegraphics[width=\linewidth]{./figures/compare_search_space.pdf}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\linewidth}
            \centering
            \includegraphics[width=\linewidth]{./figures/compare_search_space_ratio.pdf}
        \end{subfigure}
        \vspace{-.5em}
...
Since Calcite often exceeds the 10-minute limit on JOB queries\cite{full-version}, we only report the results on LDBC queries.
...
For instance, \crc{on} $\text{IC}_{5-1}$, the optimization time using \name is more than \( 10^4 \) times faster compared to Calcite.}
