...
\begin{proof}
    ...
    \begin{equation*}
        \begin{split}
            ...
            & \leq 3\sum_{i=1}^{i=k-1}s_p(i)s_p(k-i), \text{when } k \geq 2\\
        \end{split}
    \end{equation*}
