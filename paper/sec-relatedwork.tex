...
\revise{Recently, researchers have attempted to incorporate worst-case optimal joins into generated plans to better handle queries containing cycles and reduce the size of intermediate results\cite{Aberger2016Sigmod}.
...
\revise{Kùzu \cite{jin2023cidr} estimates the cost using the number of factorized tuples due to using a factorized query processor}.
