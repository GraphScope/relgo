...
Apache Age \cite{apache-age} and DuckPGQ \cite{DuckPGQ} are typical examples.
...
Typical methods of this type include Apache Age \cite{apache-age} and DuckPGQ \cite{DuckPGQ}.
