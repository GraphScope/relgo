...
Besides, according to \refdef{matching}, the outputs of the matching logical plan is a graph relation, and after the projection $\widehat{\pi}$ is applied, a relational table $\tilde{R}$ is generated.
