...
Since Lemma \ref{} indicates that matching operators can always be transformed to SPJ queries losslessly, it is ensured that this method is applicable across different scenarios.
