...
\todo{align with the converged framework}

The \name framework is implemented as a standalone system that can be integrated with various relational databases. We built \name on top of Apache Calcite~\cite{calcite}, a popular open-source data management framework, to leverage its well-established relational query optimization capabilities. 
