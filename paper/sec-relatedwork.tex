...
\revise{Recently, researchers attempt to incorporate wco joins into plans to better handle queries with cycles and reduce the size of intermediate results~\cite{Aberger2016Sigmod,free-join}.
