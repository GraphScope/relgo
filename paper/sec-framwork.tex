...
Moreover, for the \intersect operator, we crafted a new worst-case-optimal join implementation, which is expected to outperform DuckDB's multiple join implementation, which do not guarantee worst-case optimality.
