...
\begin{enumerate}
\item \revise{We map relational data models to property graph models as specified by SQL/PGQ with \rgmapping.
Based on \rgmapping, we define a new query skeleton called \spjm to better analyze the relational-graph hybrid queries}. \hfill(\refsec{preliminaries})
